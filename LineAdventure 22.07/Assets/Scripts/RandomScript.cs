...
public class RandomScript : MonoBehaviour {
    ...
    public void StartButtonClick()
    {
        ...
        DataPersistant.Instance.SetData("randomsettings", new RandomLevel(SEED, (int)Slider.value, Diff));
        DataPersistant.Instance.SetData("nextscene", "RandomGeneratedLevel");
