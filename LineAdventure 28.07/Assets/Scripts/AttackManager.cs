...
public class AttackManager : MonoBehaviour {
    ...
    public RandomPreset GetRandomPreset()
    {
        RandomPreset prest = new RandomPreset();
        return prest;
    }

    public void PutData(RandomPreset preset)
    {
        RandomPreset.AttackManagerPreset a = preset.AttackManager;
        a.AfterMoveAttack = AfterMoveAttack;
        a.AttackExecuteTime = AttackExecuteTime;
        a.ContinueMovementAfterMoveAttack = ContinueMovementAfterMoveAttack;
        a.ContinueMovementAfterProximetryAttack = ContinueMovementAfterProximetryAttack;
        a.HitHPLose = HitHPLose;
        a.HPLoseOnProximetry = HPLoseOnProximetry;
        a.ProximetryAttack = ProximetryAttack;
        a.Range = Range;
        a.ResetOnLineBreak = ResetOnLineBreak;
        a.WaitTime = WaitTime;
    ...
    {
        RandomPreset.AttackManagerPreset a = preset.AttackManager;
        AfterMoveAttack = a.AfterMoveAttack;
        AttackExecuteTime = a.AttackExecuteTime;
        ContinueMovementAfterMoveAttack = a.ContinueMovementAfterMoveAttack;
        ContinueMovementAfterProximetryAttack = a.ContinueMovementAfterProximetryAttack;
        HitHPLose = a.HitHPLose;
        HPLoseOnProximetry = a.HPLoseOnProximetry;
        ProximetryAttack = a.ProximetryAttack;
        Range = a.Range;
        ResetOnLineBreak = a.ResetOnLineBreak;
        WaitTime = a.WaitTime;
    }
    ...
    void OnUpdateVertexAttacker(object[] objects)
    {
        ...
        else  
        {
            ...
            {
                MainGameScriptObject.Damage(myline, HitHPLose);
    ...
    public class LaserAttackHandler
    {
        ...
        public static void RotateTick(AttackManager attack)
        {
            ...
            foreach(GameObject obj in (List<GameObject>)attack.DataContainer["objects"])
            {
                ...
                if (myline != MainGameScript.myLine.zero_line())
                {
                    attack.MainGameScriptObject.Damage(myline, attack.HitHPLose);
                }
            }
